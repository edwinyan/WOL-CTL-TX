...
#define RFM_NSS_GPIO	GPIOA
#define RFM_NSS_PIN		GPIO_Pin_15

#define RFM_INT_GPIO	GPIOD
#define RFM_INT_PIN		GPIO_Pin_2

#define RFM_CS_ON	GPIO_ResetBits(RFM_NSS_GPIO,RFM_NSS_PIN)
#define RFM_CS_OFF	GPIO_SetBits(RFM_NSS_GPIO,RFM_NSS_PIN)
